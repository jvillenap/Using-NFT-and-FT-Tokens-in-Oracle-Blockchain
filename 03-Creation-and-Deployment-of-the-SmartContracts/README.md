...
<p align="center">
<img width="1024" height="718" src="https://github.com/jvillenap/Using-NFT-and-FT-Tokens-in-Oracle-Blockchain/blob/main/03-Creation-and-Deployment-of-the-SmartContracts/images/3-nft-2-1.png"/>
</p>

2. Select the specification file just created, and push the button ***Import Specification***.
<p align="center">
<img width="848" height="300" src="https://github.com/jvillenap/Using-NFT-and-FT-Tokens-in-Oracle-Blockchain/blob/main/03-Creation-and-Deployment-of-the-SmartContracts/images/3-nft-2-2.png"/>
</p>

2. To be able to create a new chaincode project based in the imported specification file, we must push the plus icon (***+*** on the upper-right corner of the ***CHAINCODES*** frame of AppBuilder. It will open the ***Create Chaincode*** wizard: 
<p align="center">
<img width="960" height="675" src="https://github.com/jvillenap/Using-NFT-and-FT-Tokens-in-Oracle-Blockchain/blob/main/03-Creation-and-Deployment-of-the-SmartContracts/images/3-nft-2-3.png"/>
</p>

3. In the ***Create Chaincode*** wizard you must specify the following details, and after specifying the details push the ***Create*** button:
...
4. If everything goes fine, we should se a green message in the wizard. If this is not the case we should check the output generated during the creation of the scaffold of the project:
<p align="center">
<img width="611" height="436" src="https://github.com/jvillenap/Using-NFT-and-FT-Tokens-in-Oracle-Blockchain/blob/main/03-Creation-and-Deployment-of-the-SmartContracts/images/3-nft-2-5.png"/>
</p>

5. If the green message stating the Chaincode project has been created appears, we should se the project in the ***CHAINCODES*** frame. Clicking in the project, we should be able to navigate to the src folder inside the project, where the source code has been generated:
<p align="center">
<img width="334" height="587" src="https://github.com/jvillenap/Using-NFT-and-FT-Tokens-in-Oracle-Blockchain/blob/main/03-Creation-and-Deployment-of-the-SmartContracts/images/3-nft-2-6.png"/>
</p>
Inside the src/controller folder we will see the main class representing our smartcontract, with all the autogenerated methods for our entity, and inside the src/model folder we will see the class representing the NFT entity.
